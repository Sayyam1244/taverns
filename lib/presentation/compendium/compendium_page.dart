...
class CompendiumPage extends StatefulWidget {
  ...
  @override
  State<CompendiumPage> createState() => _CompendiumState();
}

class _CompendiumState extends State<CompendiumPage> {
  CompendiumCubit get cubit => widget.cubit;
  int? id;
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CompendiumCubit, CompendiumState>(
      bloc: cubit,
        ...
        return state.isloading
            ...
            : Scaffold(
                appBar: AppBar(
                  ...
                  elevation: 0,
                  title: AppbarSubtitleOne(text: "Compendium"),
                ),
                body: Padding(
                      ...
                      Expanded(
                        child: ValueListenableBuilder(
                          ...
                          builder: (context, v, child) {
                            List<Compendium> data = state.compendiums;
                            if (v != '') {
                              data = data
                ...
                bottomNavigationBar: Padding(
                  ...
                  child: CustomElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      List ls =
                          await getIt<DatabaseHelper>().getAllCategories();
                      List ls2 =
                          await getIt<DatabaseHelper>().getAllSubCategories();
                      if (ls.isNotEmpty && ls2.isNotEmpty) {
                        ...
                        FlushbarDialogue().showFlushbar(
                            ...
                            title: 'Error',
                            body:
                                'First add atleast 1 Category and Sub category then try adding sheets');
                      }
                    },
                  ),
                ),
